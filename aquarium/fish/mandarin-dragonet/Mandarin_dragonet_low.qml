...
Node {
    ...
    Model {
        ...
        source: "meshes/mandarin_Root_mesh.mesh"
        skin: skin
        materials: [
    ...
    Timeline {
        ...
        KeyframeGroup {
            ...
            property: "rotation"
            keyframeSource: "animations/dorsalAnterior_rotation_0.qad"
        }
        KeyframeGroup {
            target: midBody
            property: "rotation"
        ...
        KeyframeGroup {
            target: dorsalFront
            property: "position"
            keyframeSource: "animations/dorsalFront_position_0.qad"
        }
        KeyframeGroup {
            target: dorsalFront
            property: "rotation"
    ...
    Timeline {
        ...
        KeyframeGroup {
            target: dorsalAnterior
            property: "rotation"
            keyframeSource: "animations/dorsalAnterior_rotation_1.qad"
        }
        KeyframeGroup {
            target: midBody
            property: "rotation"
        ...
        KeyframeGroup {
            target: dorsalFront
            property: "position"
            keyframeSource: "animations/dorsalFront_position_1.qad"
        }
        KeyframeGroup {
            target: dorsalFront
            property: "rotation"
    ...
    Timeline {
        ...
        KeyframeGroup {
            target: dorsalAnterior
            property: "rotation"
            keyframeSource: "animations/dorsalAnterior_rotation_2.qad"
        }
        KeyframeGroup {
            target: midBody
            property: "rotation"
        ...
        KeyframeGroup {
            target: dorsalFront
            property: "position"
            keyframeSource: "animations/dorsalFront_position_2.qad"
        }
        KeyframeGroup {
            target: dorsalFront
            property: "rotation"
